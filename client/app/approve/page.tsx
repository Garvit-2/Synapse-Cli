            ...
            <div className="w-full max-w-md px-4">
                ...
                <div className="space-y-2">
                    ...
                    <div className="bg-zinc-800 rounded-lg p-4 border border-zinc-700">
                        <p className="text-xl font-moono font-bold text-cyan-400 text-center tracking-widest">{userCode ||"---"}</p>
                        </div>
                    </div>
                    ...
                    <div className=" space-y-3">
                        ...
                        <p className="text-sm text-zinc-300">Only approve this request if you initiated it . For security , never share this code with others.</p>
                        </div>
                    </div>
                </div>
                <div className="space-y-3">
                    ...
                    className="w-full h-11 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2">
                        ...
                        <span>Approving...</span></>):(<><CheckCircle className="w-5 h-5"/>
                    ...
                    className="w-full h-11 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors flex items-center justify-center gap-2">
                        {isProcessing.deny ?(<>
                        <Spinner className="w-4 h-4"/>
                        <span>Denying...</span></>):(<><XCircle className="w-5 h-5"/>
